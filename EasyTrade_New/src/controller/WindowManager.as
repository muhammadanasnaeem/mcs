...
//			initQuickOrderWindow();
		...
		{
			riskInformationWindow=initWindow(riskInformationWindow, viewManager_.riskInfo, Constants.RISK_INFORMATION_WINDOW_TITLE, Constants.RISK_INFORMATION_WINDOW_ID, 1135, 607);
...
//			bulletinControlWindow.addEventListener(MDIWindowEvent.FOCUS_START, bulletinControl_FocusStartHandler);
		...
		public function initBuyOrderWindow():Object
		{
			...
			{
				buyOrderWindow=initWindow(buyOrderWindow, viewManager_.buyOrder, Constants.BUY_ORDER_WINDOW_TITLE, Constants.BUY_ORDER_WINDOW_ID, 635, 510, false);
...
//				viewManager_.buyOrder.okButton.addEventListener(MouseEvent.CLICK,modelManager_.submitBuyOrderOnClick);
			...
			{
				buyOrderWindow=initWindow(buyOrderWindow, viewManager_.buyOrder, Constants.BUY_ORDER_WINDOW_TITLE, Constants.BUY_ORDER_WINDOW_ID, 635, 440, false);
...
//			viewManager_.buyOrder.focusManager.setFocus(viewManager_.buyOrder.txtExchange);
		...
		public function initSellOrderWindow():Object
		{
			...
			{
				sellOrderWindow=initWindow(sellOrderWindow, viewManager_.sellOrder, Constants.SELL_ORDER_WINDOW_TITLE, Constants.SELL_ORDER_WINDOW_ID, 635, 510, false);
			...
			{
				sellOrderWindow=initWindow(sellOrderWindow, viewManager_.sellOrder, Constants.SELL_ORDER_WINDOW_TITLE, Constants.SELL_ORDER_WINDOW_ID, 635, 440, false);
...
//				Alert.show('aaa');
			...
			changeOrderWindow=initWindow(changeOrderWindow, viewManager_.changeOrder, Constants.CHANGE_ORDER_WINDOW_TITLE, Constants.CHANGE_ORDER_WINDOW_ID, 635, 440, false);
...
//			viewManager_.changeOrder.okButton.addEventListener(MouseEvent.CLICK,viewManager_.changeOrder.txtOrderNum_keyDownHandler1);
		...
		public function initCancelOrderWindow():MDIWindow
		{
			...
			ModelManager.getInstance().updateRemainingOrders();
			cancelOrderWindow=initWindow(cancelOrderWindow, viewManager_.cancelOrder, Constants.CANCEL_ORDER_WINDOW_TITLE, Constants.CANCEL_ORDER_WINDOW_ID, 635, 440, false);
...
//			viewManager_.cancelOrder.okButton.addEventListener(MouseEvent.CLICK,viewManager_.cancelOrder.txtOrderNum_keyDownHandler1);
		...
		{
			cancelAllOrdersWindow=initWindow(cancelAllOrdersWindow, viewManager_.cancelAllOrders, Constants.CANCEL_ALL_ORDERS_WINDOW_TITLE, Constants.CANCEL_ALL_ORDERS_WINDOW_ID, 300, 200, false);
		...
		{
			yieldCalculatorWindow=initWindow(yieldCalculatorWindow, viewManager_.yieldCalculator, Constants.YIELD_CALCULATOR_WINDOW_TITLE, Constants.YIELD_CALCULATOR_WINDOW_ID, 330, 230, false);
		...
		{
			changePasswordWindow=initWindow(changePasswordWindow, viewManager_.changePassword, Constants.CHANGE_PASSWORD_WINDOW_TITLE, Constants.CHANGE_PASSWORD_WINDOW_ID, 324, 178, false);
		...
		{
			marketScheduleWindow=initWindow(marketScheduleWindow, viewManager_.marketSchedule, Constants.MARKET_SCHEDULE_WINDOW_TITLE, Constants.MARKET_SCHEDULE_WINDOW_ID, 500, 200);
		}

		///////////////////////////////////////////////////////////////
		public function initMarketScheduleControlWindow():void
		{
			marketScheduleControlWindow=initWindow(marketScheduleControlWindow, viewManager_.marketScheduleControl, Constants.MARKET_SCHEDULE_CONTROL_WINDOW_TITLE, Constants.MARKET_SCHEDULE_CONTROL_WINDOW_ID, 440, 255);
		...
		{
			symbolStateControlWindow=initWindow(symbolStateControlWindow, viewManager_.symbolStateControl, Constants.SYMBOL_STATE_CONTROL_WINDOW_TITLE, Constants.SYMBOL_STATE_CONTROL_WINDOW_ID, 280, 220);
		...
		{
			bulletinControlWindow=initWindow(bulletinControlWindow, viewManager_.bulletinControl, Constants.BULLETIN_CONTROL_WINDOW_TITLE, Constants.BULLETIN_CONTROL_WINDOW_ID, 400, 300);
		...
		{
			orderLimitControlWindow=initWindow(orderLimitControlWindow, viewManager_.orderLimitControl, Constants.ORDER_LIMIT_CONTROL_WINDOW_TITLE, Constants.ORDER_LIMIT_CONTROL_WINDOW_ID, 400, 200);
...
//				liveMessages.restore();
		...
		{
			exchangeStatsWindow=initWindow(exchangeStatsWindow, viewManager_.exchangeStats, Constants.EXCHANGE_STATS_WINDOW_TITLE, Constants.EXCHANGE_STATS_WINDOW_ID, 550, 500);
		...
		{
			symbolBrowserWindow=initWindow(symbolBrowserWindow, viewManager_.symbolBrowser, Constants.SYMBOL_BROWSER_WINDOW_TITLE, Constants.SYMBOL_BROWSER_WINDOW_ID, 650, 400);
		...
		{
			symbolSummWindow=initWindow(symbolSummWindow, viewManager_.symbolSumm, Constants.SYMBOL_SUMMARY_WINDOW_TITLE, Constants.SYMBOL_SUMMARY_WINDOW_ID, 760, 330, false);
...
//			symbolSummWindow.minHeight = 510;
		...
		{
			marketSummaryWindow=initWindow(marketSummaryWindow, viewManager_.marketSummary, Constants.MARKET_SUMMARY_WINDOW_TITLE, Constants.MARKET_SUMMARY_WINDOW_ID, 760, 330, false);
		...
		public function initLastDayRemainingOrdersWindow():void
		{
			...
			lastDayRemainingOrdersWindow=initWindow(lastDayRemainingOrdersWindow, viewManager_.lastDayRemainingOrders, Constants.LAST_DAY_REMAINING_ORDERS_WINDOW_TITLE, Constants.LAST_DAY_REMAINING_ORDERS_WINDOW_ID, 650, 400);
		...
		{
			bestOrdersWindow=initWindow(bestOrdersWindow, viewManager_.bestOrders, Constants.BEST_ORDERS_WINDOW_TITLE, Constants.BEST_ORDERS_WINDOW_ID, 580, 350);
		...
		{
			bestPricesWindow=initWindow(bestPricesWindow, viewManager_.bestPrices, Constants.BEST_PRICES_WINDOW_TITLE, Constants.BEST_PRICES_WINDOW_ID, 580, 350);
		...
		{
			profileSettingsWindow=initWindow(profileSettingsWindow, viewManager.profileSetting, Constants.PROFILE_WINDOW_TITLE, Constants.PROFILE_WINDOW_ID, 420, 305, false);
