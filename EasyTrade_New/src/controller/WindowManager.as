...
//		mdiwin.
		...
		/////////////////////Historical Symbol Data Charts Window///////////////////// 
		
		private var historicalSymbolDataCharts_:MDIWindow;
		
		public function get historicalSymbolDataCharts():MDIWindow
		{
			return historicalSymbolDataCharts_;
		}
		
		public function set historicalSymbolDataCharts(value:MDIWindow):void
		{
			historicalSymbolDataCharts_=value;
		}
		
		/////////////////////Historical Symbol Window/////////////////////
		
		private var historicalSymbolWindow_:MDIWindow;
		
		public function get historicalSymbolWindow():MDIWindow
		{
			return historicalSymbolWindow_;
		}
		
		public function set historicalSymbolWindow(value:MDIWindow):void
		{
			historicalSymbolWindow_=value;
		}
...
//			bulletinControlWindow.addEventListener(MDIWindowEvent.FOCUS_START, bulletinControl_FocusStartHandler);
		...
		///////////////////////////////////////////////////////////////
		public function inithistoricalSymbolDataChartsWindow():Object
		{
			historicalSymbolDataCharts=initWindow(historicalSymbolDataCharts, viewManager_.histsymDataCharts, ResourceManager.getInstance().getString('marketwatch', 'historicalSymbolDataChart'), Constants.RISK_INFORMATION_WINDOW_ID, 1024, 289);
			historicalSymbolDataCharts.resizable=true;
			historicalSymbolDataCharts.left=200;
			historicalSymbolDataCharts.bottom=217;
			historicalSymbolDataCharts.minWidth=1024;
			historicalSymbolDataCharts.verticalScrollPolicy="off";
			historicalSymbolDataCharts.horizontalScrollPolicy="off";
			// added on 18/1/2011
			//			bulletinControlWindow.addEventListener(MDIWindowEvent.FOCUS_START, bulletinControl_FocusStartHandler);
			return historicalSymbolDataCharts;
		}
		
		///////////////////////////////////////////////////////////////
		public function inithistoricalSymbolWindow():Object
		{
			historicalSymbolWindow=initWindow(historicalSymbolWindow, viewManager_.historicalSymbolDataInfo, ResourceManager.getInstance().getString('marketwatch', 'historicalSymbolData'), Constants.RISK_INFORMATION_WINDOW_ID, 1135, 607);
			historicalSymbolWindow.resizable=true;
			historicalSymbolWindow.minWidth=750;
			historicalSymbolWindow.minHeight=300;
			historicalSymbolWindow.verticalScrollPolicy="off";
			historicalSymbolWindow.horizontalScrollPolicy="off";
			// added on 18/1/2011
			//			bulletinControlWindow.addEventListener(MDIWindowEvent.FOCUS_START, bulletinControl_FocusStartHandler);
			return historicalSymbolWindow;
		}
...
//			viewManager_.cancelOrder.okButton.addEventListener(MouseEvent.CLICK,viewManager_.cancelOrder.txtOrderNum_keyDownHandler1);
		...
		{
			marketScheduleControlWindow=initWindow(marketScheduleControlWindow, viewManager_.marketScheduleControl, ResourceManager.getInstance().getString('marketwatch', 'marketSchedule'), Constants.MARKET_SCHEDULE_CONTROL_WINDOW_ID, 440, 255,false);
