	...
	if(event.currentTarget.id == "txtPrice" && txtPrice.text != "" && txtPrice.text != "0") 
	{
		...
		if (internalExchangeID > -1 && internalMarketID > -1 && internalSymbolID > -1)
		{
			...
			if (obj.hasOwnProperty("SYMBOL_TYPE") && obj.SYMBOL_TYPE == "Bond")
			{
				...
				//QWClient.getInstance().calculateYieldFromSellOrderWindow(yield);
			}
		}
	}
	else
		...
		if (event.currentTarget.editable)
		{
			if (isFirstSubmission)
			{
				...
				else
				{
					...
					ModelManager.getInstance().remainingOrdersModel.sellOrderView=this;
...
[Bindable]
private var bndPanel0:Number=115;
...
//////////// Commented for design constraints.
//
//[Bindable]
//private var bondPanel1HeightMin:Number = 158;
//[Bindable]
//private var bondPanel1HeightMax:Number = 239;
//
//[Bindable]
//private var bondPanel1BottomRulePositionNormal:Number = 278;
//
//[Bindable]
//private var bondPanel1BottomRulePositionExpanded:Number = 359;
//
//[Bindable]
//private var marketDataTitlePositionNormal2:Number = 296;
//
//[Bindable]
//private var marketDataTitlePositionExpaded2:Number = 369;
//
//[Bindable]
//private var marketDataTopLeftRulePositionNormal2:Number = 298;
//
//[Bindable]
//private var marketDataTopLeftRulePositionExpanded2:Number = 371;
//
//[Bindable]
//private var marketDataTopRightRulePositionNormal2:Number = 301;
//
//[Bindable]
//private var marketDataTopRightRulePositionExpanded2:Number = 374;
//
//[Bindable]
//private var marketDataLeftRulePositionNormal2:Number = 301;
//
//[Bindable]
//private var marketDataLeftRulePositionExpanded2:Number = 374;
//
//[Bindable]
//private var marketDataRightRulePositionNormal2:Number = 300;
//
//[Bindable]
//private var marketDataRightRulePositionExpanded2:Number = 373;
//
//[Bindable]
//private var marketDataBottomRulePositionNormal2:Number = 431;
//
//[Bindable]
//private var marketDataBottomRulePositionExpanded2:Number = 504;
//
//[Bindable]
//private var marketDataBidPositionNormal2:Number = 312;
//
//[Bindable]
//private var marketDataBidPositionExpanded2:Number = 385;
//
//[Bindable]
//private var txtBuyPositionNormal2:Number = 326;
//
//[Bindable]
//private var txtBuyPositionExpanded2:Number = 399;
//
//[Bindable]
//private var txtLastPositionNormal2:Number = 354;
//
//[Bindable]
//private var txtLastPositionExpanded2:Number = 427;
//
//[Bindable]
//private var marketDataLastPositionNormal2:Number = 376;
//
//[Bindable]
//private var marketDataLastPositionExpanded2:Number = 449;
//
//[Bindable]
//private var marketDataOpenPostionNormal2:Number = 405;
//
//[Bindable]
//private var marketDataOpenPostionExpanded2:Number = 478;
//
//[Bindable]
//private var txtOpen1PositionNormal2:Number = 397;
//
//[Bindable]
//private var txtOpen1PositionExpanded2:Number = 470;
//
//[Bindable]
//private var messagesTxtLabelPositionNormal2:Number = 448;
//
//[Bindable]
//private var messagesTxtLabelPositionExpanded2:Number = 521;
//
//[Bindable]
//private var txtMsgPositionNormal2:Number = 448;
//
//[Bindable]
//private var txtMsgPositionExpanded2:Number = 521;
//
//[Bindable]
//private var btnSubmitPostionNormal2:Number = 478;
//
//[Bindable]
//private var btnSubmitPostionExpanded2:Number = 551;
//
//[Bindable]
//private var btnCancelPositionNormal2:Number = 478;
//
//[Bindable]
//private var btnCancelPositionExpanded2:Number = 551;
//
//[Bindable]
//private var marketDataChangePositionNormal2:Number = 377;
//
//[Bindable]
//private var marketDataChangePositionExpanded2:Number = 450;
//
//[Bindable]
//private var bondPanelPositionNormal2:Number = 169;
//
//[Bindable]
//private var bondPanelPositionExpanded2:Number = 233;
//
//[Bindable]
//private var additionalOrdersDetailsRuleBottomPositionNormal2:Number = 211;
//
//[Bindable]
//private var additionalOrdersDetailsRuleBottomPositionExpanded2:Number = 278;
/**
 * Reset Order View
 */
...
public function updateSymbolStatsOrderFields(event:NonVisualItemUpdateEvent):void
{
		...
		&& windowManager.viewManager.quickOrders.fourthSymbolDropDown!= null)
	{
		...
		//		{
		//			windowManager.viewManager.quickOrders.secondChangeValue.setStyle("backgroundColor", 0x01e92a);
		//			windowManager.viewManager.quickOrders.secondChangeValue.text='+' + numberFormatter.format(LSListener.extractFieldData(updatedFields, 8, index)).toString().slice(0, 5);
		//		}
		...
		//		{
		//			windowManager.viewManager.quickOrders.thirdChangeValue.setStyle("backgroundColor", 0x01e92a);
		//			windowManager.viewManager.quickOrders.thirdChangeValue.text='+' + numberFormatter.format(LSListener.extractFieldData(updatedFields, 8, index)).toString().slice(0, 5);
		//		}
...
//			bg.height = pnlHeightMin;
			...
			windowManager.sellOrderWindow.height=windowHeight1;
			...
			btnSubmit.y=okButtonPostionNormal;
			btnCancel.y=cancelButtonPositionNormal;
...
//			bg.height = pnlHeightMax;
			...
			windowManager.sellOrderWindow.height=windowHeight;
			...
			btnSubmit.y=okButtonPostionExpanded;
			btnCancel.y=cancelButtonPositionExpanded;
